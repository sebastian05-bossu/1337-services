...
createToggle(catContents["Misc"], "New Server", function() TeleportService:Teleport(game.PlaceId, LocalPlayer) end)
-- === STEAL ===
yPos = 10
...
        if key == validKey then found = true break end
    end
    if not found then
